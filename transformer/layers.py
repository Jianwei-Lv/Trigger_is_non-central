...
class EncoderLayer(nn.Module):
    ...
    def forward(self, enc_inputs,data_type, self_attn_mask,scale_factor=True,attn_=None):
        # enc_outputs, attn = self.enc_self_attn(enc_inputs, enc_inputs,
        #                                        enc_inputs, attn_mask=self_attn_mask)
        enc_outputs, attn = self.enc_self_attn(enc_inputs,data_type,
                                               data_type, attn_mask=self_attn_mask,scale_factor=scale_factor,attn_=attn_)
